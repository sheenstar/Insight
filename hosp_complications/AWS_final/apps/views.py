...
def cesareans_output():
  ...
  if value not in state_model_aves:
    raise ValueError("The abbreviation you typed in was not found. Make sure you're using a two letter abbreviation in capital letters. ")

  state_model_aves.keys()
